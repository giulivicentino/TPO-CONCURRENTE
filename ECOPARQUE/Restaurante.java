 ...
 * int dif1y2= Math.abs(restaurantes.get(1)[0] - restaurantes.get(2)[0]) ; //
 * resta actuales de resto 1 con los de resto2
 ...
 * System.out.println(Thread.currentThread().getName() +
 * " entre a RESTO 1, ahora la cant actual es: "+restaurantes.get(1)[0]+
 * " y el max es 10");
 * 
 * }else if(restaurantes.get(2)[0]<15){ // se fija en el segundo
 * System.out.println(Thread.currentThread().getName() +
 * " entre a RESTO 2, ahora la cant actual es: "+restaurantes.get(1)[0]+
 * " y el max es 10");
 * 
 * }else if(restaurantes.get(3)[0]<20){ //sino se queda esperando en el tercero
 * System.out.println(Thread.currentThread().getName() +
 * " entre a RESTO 3, ahora la cant actual es: "+restaurantes.get(1)[0]+
 * " y el max es 10");
 * 
